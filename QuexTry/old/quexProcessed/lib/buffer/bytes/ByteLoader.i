...
#ifndef  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BYTES__BYTE_LOADER_I
#define  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BYTES__BYTE_LOADER_I



inline quexProcessed_stream_position_t
quexProcessed_ByteLoader_tell(quexProcessed_ByteLoader* me);

inline void
quexProcessed_ByteLoader_seek(quexProcessed_ByteLoader* me, quexProcessed_stream_position_t Position);

inline size_t                    
quexProcessed_ByteLoader_load(quexProcessed_ByteLoader* me, void* begin_p, const size_t N, bool* end_of_stream_f);

inline void                    
quexProcessed_ByteLoader_print_this(quexProcessed_ByteLoader* me);

inline void
quexProcessed_ByteLoader_construct(quexProcessed_ByteLoader* me, 
...
{
    me->tell               = quexProcessed_ByteLoader_tell;
    me->seek               = quexProcessed_ByteLoader_seek;
    me->load               = quexProcessed_ByteLoader_load;
    me->print_this         = quexProcessed_ByteLoader_print_this;
    ...
    me->on_nothing         = (bool  (*)(struct quexProcessed_ByteLoader_tag*, size_t, size_t))0;
...
inline void
quexProcessed_ByteLoader_seek_disable(quexProcessed_ByteLoader* me)
{
    me->derived.seek = (void (*)(quexProcessed_ByteLoader*, quexProcessed_stream_position_t))0;
}

inline bool
quexProcessed_ByteLoader_seek_is_enabled(quexProcessed_ByteLoader* me)
{
...
inline bool
quexProcessed_ByteLoader_is_equivalent(const quexProcessed_ByteLoader* A, 
...
inline void  
quexProcessed_ByteLoader_delete(quexProcessed_ByteLoader** me)
{
    if( ! *me )                   return;
    else if( (*me)->delete_self ) (*me)->delete_self(*me);
    (*me) = (quexProcessed_ByteLoader*)0;
}
...
#include "quexProcessed/lib/buffer/bytes/ByteLoader_FILE.i"
#include "quexProcessed/lib/buffer/bytes/ByteLoader_stream.i"
#include "quexProcessed/lib/buffer/bytes/ByteLoader_wstream.i"

#endif /*  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BYTES__BYTE_LOADER_I */
