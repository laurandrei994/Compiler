...
#ifndef  QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__LEXATOMS__CONVERTER__CONVERTER_I
#define  QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__LEXATOMS__CONVERTER__CONVERTER_I
...
#include "lexical_analysis/lib/quex/MemoryManager"
 ...
 bool
Calc_lexer_Converter_construct(Calc_lexer_Converter* me,
                               const char*  FromCodec, const char* ToCodec,
                               bool         (*initialize)(Calc_lexer_Converter*, 
                                                          const char* FromCodingName, 
                                                          const char* ToCodingName),  
                               bool         (*initialize_by_bom_id)(Calc_lexer_Converter*, 
                                                                    E_ByteOrderMark),
                               E_LoadResult (*convert)(Calc_lexer_Converter*, 
                                                       uint8_t**             source, const uint8_t*             SourceEnd, 
                                                       Calc_lexer_lexatom_t** drain,  const Calc_lexer_lexatom_t* DrainEnd),
                               void         (*delete_self)(Calc_lexer_Converter*),
                               ptrdiff_t    (*stomach_byte_n)(Calc_lexer_Converter*),
                               void         (*stomach_clear)(Calc_lexer_Converter*),
                               void         (*print_this)(Calc_lexer_Converter*))
 ...
 *          false -- else.                                                    */
{
     ...
     * to unicode of size sizeof(Calc_lexer_lexatom_t). 
     *
     * It is the task of the particular implementation to provide the 'ToCodec'
     * which is appropriate for sizeof(Calc_lexer_lexatom_t), i.e.  ASCII, UCS2,
     * UCS4.                                                                  */
 ...
 void
Calc_lexer_Converter_reset(Calc_lexer_Converter* me)
{
    me->stomach_clear(me);
    me->virginity_f = true;
}
 ...
 void
Calc_lexer_Converter_print_this(Calc_lexer_Converter* me)
{
...
#endif /*  QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__LEXATOMS__CONVERTER__CONVERTER_I     */
