...
#ifndef  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__CONVERTER__RECODE__CONVERTER_RECODE_I
#define  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__CONVERTER__RECODE__CONVERTER_RECODE_I
...
#include "compilator\lib\quex/MemoryManager"
     ...
     *                  source bytes are required.                           */
    {
        ...
        if( me->to_handle == 0x0 ) {
            /* Convert according to compilator_lexatom_t:
             *
             ...
             *       of compilator_lexatom_t. If you read these lines and know of a better
            ...
            __quex_assert( sizeof(compilator_lexatom_t) == 2 );
            ...
            ucnv_convertEx(me->to_handle, me->from_handle,
                           ...
                           me->pivot_buffer + QUEX_compilator_SETTING_ICU_PIVOT_BUFFER_SIZE,
                           /* reset = */FALSE, 
                           /* flush = */FALSE,
                           &me->status);
