...
#ifndef  QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__LEXATOMS__CONVERTER__ICU__CONVERTER_ICU_I
#define  QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__LEXATOMS__CONVERTER__ICU__CONVERTER_ICU_I

#include "lexical_analysis/lib/definitions"
#include "lexical_analysis/lib/buffer/lexatoms/converter/icu/Converter_ICU"
...
#include "lexical_analysis/lib/analyzer/configuration/validation"
 ...
 bool
Calc_lexer_Converter_ICU_initialize(Calc_lexer_Converter* me, 
                                    const char*           FromCoding, 
                                    const char*           ToCoding);
 bool    
Calc_lexer_Converter_ICU_initialize_by_bom_id(Calc_lexer_Converter* me,
                                              E_ByteOrderMark         BomId);

 E_LoadResult
Calc_lexer_Converter_ICU_convert(Calc_lexer_Converter*       me, 
                                 uint8_t**                   source, 
                                 const uint8_t*              SourceEnd, 
                                 Calc_lexer_lexatom_t**       drain,  
                                 const Calc_lexer_lexatom_t*  DrainEnd);
 void
Calc_lexer_Converter_ICU_delete_self(Calc_lexer_Converter* me);

 ptrdiff_t 
Calc_lexer_Converter_ICU_stomach_byte_n(Calc_lexer_Converter* me);

 void 
Calc_lexer_Converter_ICU_stomach_clear(Calc_lexer_Converter* me);

 void 
Calc_lexer_Converter_ICU_print_this(Calc_lexer_Converter* me);

 Calc_lexer_Converter*
Calc_lexer_Converter_ICU_new(const char* FromCoding, const char* ToCoding)
{
    Calc_lexer_Converter_ICU*  me = \
         (Calc_lexer_Converter_ICU*)quex_MemoryManager_allocate(sizeof(Calc_lexer_Converter_ICU),
    ...
    if( ! Calc_lexer_Converter_construct(&me->base,
                                         FromCoding, ToCoding,
                                         Calc_lexer_Converter_ICU_initialize,
                                         Calc_lexer_Converter_ICU_initialize_by_bom_id,
                                         Calc_lexer_Converter_ICU_convert,
                                         Calc_lexer_Converter_ICU_delete_self,
                                         Calc_lexer_Converter_ICU_stomach_byte_n,
                                         Calc_lexer_Converter_ICU_stomach_clear,
                                         Calc_lexer_Converter_ICU_print_this) ) {
 ...
 bool
Calc_lexer_Converter_ICU_initialize(Calc_lexer_Converter* alter_ego, 
                                    const char*           FromCoding, 
                                    const char*           ToCoding)
...
{
    Calc_lexer_Converter_ICU* me = (Calc_lexer_Converter_ICU*)alter_ego;
...
ERROR:
 ...
 bool    
Calc_lexer_Converter_ICU_initialize_by_bom_id(Calc_lexer_Converter* alter_ego,
                                              E_ByteOrderMark         BomId)
{
    Calc_lexer_Converter_ICU* me = (Calc_lexer_Converter_ICU*)alter_ego;
    const char* name;
    ...
    return Calc_lexer_Converter_ICU_initialize(alter_ego, name, NULL);
}

 E_LoadResult
Calc_lexer_Converter_ICU_convert(Calc_lexer_Converter*       alter_ego, 
                                 uint8_t**                   source, 
                                 const uint8_t*              SourceEnd, 
                                 Calc_lexer_lexatom_t**       drain,  
                                 const Calc_lexer_lexatom_t*  DrainEnd)
 ...
 *                  more source bytes are required.                      */
{
    ...
    __quex_assert(me->pivot.target     <= &me->pivot.buffer[QUEX_Calc_lexer_SETTING_ICU_PIVOT_BUFFER_SIZE]);
    ...
    ucnv_convertEx(me->to_handle, me->from_handle,
                   ...
                   &me->pivot.buffer[0], &me->pivot.source, &me->pivot.target, &me->pivot.buffer[QUEX_Calc_lexer_SETTING_ICU_PIVOT_BUFFER_SIZE],
 ...
 ptrdiff_t 
Calc_lexer_Converter_ICU_stomach_byte_n(Calc_lexer_Converter* alter_ego)
...
#   endif 
 ...
 void 
Calc_lexer_Converter_ICU_stomach_clear(Calc_lexer_Converter* alter_ego)
{
    Calc_lexer_Converter_ICU* me = (Calc_lexer_Converter_ICU*)alter_ego;
 ...
 void
Calc_lexer_Converter_ICU_delete_self(Calc_lexer_Converter* alter_ego)
{
    Calc_lexer_Converter_ICU* me = (Calc_lexer_Converter_ICU*)alter_ego;
 ...
 void 
Calc_lexer_Converter_ICU_print_this(Calc_lexer_Converter* alter_ego)
{
    Calc_lexer_Converter_ICU* me = (Calc_lexer_Converter_ICU*)alter_ego;
    const void*  PivotBegin = (const void*)&me->pivot.buffer[0];
    const void*  PivotEnd   = (const void*)&me->pivot.buffer[QUEX_Calc_lexer_SETTING_ICU_PIVOT_BUFFER_SIZE];
    ...
    QUEX_DEBUG_PRINT3("           buffer: { begin: ((%p)) end: ((%p)) size: %i; }\n",
                      PivotBegin, PivotEnd, (int)QUEX_Calc_lexer_SETTING_ICU_PIVOT_BUFFER_SIZE);
    QUEX_DEBUG_PRINT("           source: ");
    quex_print_relative_positions(PivotBegin, PivotEnd, sizeof(UChar),
