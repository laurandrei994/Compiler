...
#ifndef QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__BUFFER_FILL_I
#define QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__BUFFER_FILL_I
...
#include "lexical_analysis/lib/buffer/Buffer"
 ...
 const void*
Calc_lexer_Buffer_fill(Calc_lexer_Buffer*  me, 
 ...
 *          == ContentBegin, in case that nothing has been filled.          */
{
    ...
    copy_n = (ptrdiff_t)quex_MemoryManager_insert((uint8_t*)begin_p,  
                                                             (uint8_t*)end_p,
 ...
 bool
Calc_lexer_Buffer_fill_prepare(Calc_lexer_Buffer*  me, 
                               void**              begin_p, 
                               const void**        end_p)
 ...
 * 'raw' buffer which still needs to be converted.                          */
{
    ...
    if( move_distance ) {
        (void)Calc_lexer_Buffer_move_towards_begin(me, move_distance,
 ...
 void
Calc_lexer_Buffer_fill_finish(Calc_lexer_Buffer* me,
 ...
 *                                                                           */
{
    __quex_assert((Calc_lexer_lexatom_t*)FilledEndP <= me->content_space_end(me));
    ...
    if( me->filler->_byte_order_reversion_active_f ) {
        Calc_lexer_LexatomLoader_reverse_byte_order(me->content_end(me), 
     ...
     *                                                                       */
    Calc_lexer_Buffer_register_content(me, &me->content_end(me)[inserted_lexatom_n], -1);
...
#endif /* QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__BUFFER_FILL_I */
