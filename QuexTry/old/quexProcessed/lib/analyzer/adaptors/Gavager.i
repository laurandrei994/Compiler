...
#ifndef QUEX_INCLUDE_GUARD_quexProcessed__ANALYZER__ADAPTORS__GAVAGER_I
#define QUEX_INCLUDE_GUARD_quexProcessed__ANALYZER__ADAPTORS__GAVAGER_I

#include "quexProcessed/lib/analyzer/adaptors/Gavager"
...
inline
quexProcessed_Gavager::quexProcessed_Gavager(quexProcessed* lexer,
                                       quexProcessed_token_id_t  StreamTerminatingTokenId)
{ quexProcessed_Gavager_construct(this, lexer, StreamTerminatingTokenId); }

inline bool
quexProcessed_Gavager::access(void** begin_p, const void** end_p)
{ return quexProcessed_Gavager_access(this, begin_p, end_p); }

inline bool
quexProcessed_Gavager::gavage(ptrdiff_t ReceivedN)
{ return quexProcessed_Gavager_gavage(this, ReceivedN); }

inline quexProcessed_Token* 
quexProcessed_Gavager::deliver()
{ return quexProcessed_Gavager_deliver(this); }



inline void
quexProcessed_Gavager_construct(quexProcessed_Gavager*  me, 
                             quexProcessed*     lexer,
                             quexProcessed_token_id_t      StreamTerminatingTokenId)
{
    /* Initialization                                                        */
...
inline bool
quexProcessed_Gavager_access(quexProcessed_Gavager* me,
...
{
    quexProcessed_Buffer* buffer = &me->base.lexer->buffer;
    return buffer->fill_prepare(&me->base.lexer->buffer, begin_p, end_p);
}

inline bool
quexProcessed_Gavager_gavage(quexProcessed_Gavager* me, ptrdiff_t ReceivedN)
{
    void*              begin_p;
    const void*        end_p;
    quexProcessed_Buffer* buffer = &me->base.lexer->buffer;
...
{
    return quexProcessed_receive_from_chunk(me->base.lexer, true, 
...
#include "quexProcessed/lib/analyzer/adaptors/Feeder.i"

#endif /*  QUEX_INCLUDE_GUARD_quexProcessed__ANALYZER__ADAPTORS__GAVAGER_I */
