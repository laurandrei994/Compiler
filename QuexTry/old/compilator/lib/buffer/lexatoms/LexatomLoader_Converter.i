...
#ifndef  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_I
#define  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_I
...
inline void
compilator_LexatomLoader_Converter_construct(compilator_LexatomLoader_Converter* me, 
                                             compilator_ByteLoader*              byte_loader,
                                             compilator_Converter*               converter,
                                             size_t                              RawMemorySize);

inline void   
compilator_LexatomLoader_Converter_stomach_clear(compilator_LexatomLoader* alter_ego);

inline void   
compilator_LexatomLoader_Converter_destruct_self(compilator_LexatomLoader* alter_ego);

inline ptrdiff_t   
compilator_LexatomLoader_Converter_stomach_byte_n(compilator_LexatomLoader* alter_ego);

inline size_t 
compilator_LexatomLoader_Converter_load_lexatoms(compilator_LexatomLoader*  alter_ego,
                                                 compilator_lexatom_t*         RegionBeginP, 
                                                 const size_t               N,
                                                 bool*                      end_of_stream_f,
                                                 bool*                      encoding_error_f);
inline void 
compilator_LexatomLoader_Converter_fill_prepare(compilator_LexatomLoader*  alter_ego,
                                                compilator_Buffer*         buffer,
                                                void**                     begin_p,
                                                const void**               end_p);

inline void 
compilator_LexatomLoader_Converter_get_fill_boundaries(compilator_LexatomLoader*  alter_ego,
                                                       compilator_Buffer*         buffer,
                                                       void**       begin_p, 
                                                       const void** end_p);

inline ptrdiff_t 
compilator_LexatomLoader_Converter_fill_finish(compilator_LexatomLoader*   alter_ego,
                                              compilator_lexatom_t*       insertion_p,
                                              const compilator_lexatom_t* BufferEnd,
                                              const void*                ContentEnd);

inline E_LoadResult
compilator_LexatomLoader_call_converter(compilator_LexatomLoader_Converter* me,
                                        compilator_lexatom_t**                 insertion_p,
                                        compilator_lexatom_t*                  RegionBeginP,
                                        const compilator_lexatom_t*            RegionEndP);
inline void
compilator_LexatomLoader_remove_spurious_BOM(compilator_LexatomLoader_Converter* me,
                                            compilator_lexatom_t**                  buffer_insertion_p,
                                            compilator_lexatom_t*                   RegionBeginP);

inline void 
compilator_LexatomLoader_Converter_print_this(compilator_LexatomLoader* alter_ego);

inline void   
compilator_RawBuffer_init(compilator_RawBuffer* me, 
                          uint8_t* Begin, size_t SizeInBytes);
inline void 
compilator_RawBuffer_move_away_passed_content(compilator_RawBuffer*  me);

inline bool 
compilator_RawBuffer_load(compilator_RawBuffer*   me,
                          compilator_ByteLoader*  byte_loader, 
                          bool*                   end_of_stream_f);

inline compilator_LexatomLoader*
compilator_LexatomLoader_Converter_new(compilator_ByteLoader* byte_loader,
                                       compilator_Converter*  converter)
{ 
    compilator_LexatomLoader_Converter*  me;
    /* UTF-8 char can be 6 bytes long => min. size of translation buffer.    */
    __quex_assert(QUEX_compilator_SETTING_BUFFER_LEXATOM_LOADER_CONVERTER_BUFFER_SIZE >= 6);  
...
#   endif
    ...
    me = (compilator_LexatomLoader_Converter*) \
          quex::MemoryManager_allocate(sizeof(compilator_LexatomLoader_Converter),
                                         E_MemoryObjectType_BUFFER_FILLER);
    if( ! me) {
        return (compilator_LexatomLoader*)0;
    }

    compilator_LexatomLoader_Converter_construct(me, byte_loader, converter, 
                                                 QUEX_compilator_SETTING_BUFFER_LEXATOM_LOADER_CONVERTER_BUFFER_SIZE);
                                             ...
                                             size_t                              RawMemorySize)
{
    ...
    compilator_LexatomLoader_setup(&me->base,
                                  compilator_LexatomLoader_Converter_load_lexatoms,
                                  compilator_LexatomLoader_Converter_stomach_byte_n,
                                  compilator_LexatomLoader_Converter_stomach_clear,
                                  compilator_LexatomLoader_Converter_destruct_self,
                                  compilator_LexatomLoader_Converter_fill_prepare,
                                  compilator_LexatomLoader_Converter_fill_finish,
                                  compilator_LexatomLoader_Converter_get_fill_boundaries,
                                  compilator_LexatomLoader_Converter_print_this,
                                  byte_loader,
                                  byte_n_per_lexatom);
    ...
    compilator_RawBuffer_init(&me->raw_buffer, raw_memory, RawMemorySize);
 ...
 *                 in the stomach.                                           */
{
    compilator_LexatomLoader_Converter* me = (compilator_LexatomLoader_Converter*)alter_ego;
    ptrdiff_t  byte_n;
...
{
    compilator_LexatomLoader_Converter* me = (compilator_LexatomLoader_Converter*)alter_ego;
    compilator_RawBuffer_init(&me->raw_buffer, 0, 0);
    compilator_Converter_reset(me->converter);
}
...
{
    compilator_LexatomLoader_Converter* me = (compilator_LexatomLoader_Converter*)alter_ego;
    compilator_RawBuffer*               raw = &me->raw_buffer;
    compilator_lexatom_t*                  buffer_insertion_p = RegionBeginP;
    const compilator_lexatom_t*            BufferRegionEnd    = &RegionBeginP[N];
    E_LoadResult                        load_result;
    bool                                raw_load_complete_f;
    bool                                raw_end_of_stream_f;
#   if 0
    int                              i;
    compilator_lexatom_t*               buffer_insertion_begin_p;
#   endif
    ...
    load_result = compilator_LexatomLoader_call_converter(me, &buffer_insertion_p, 
                                                          RegionBeginP,
                                                          BufferRegionEnd);
    ...
    while( load_result == E_LoadResult_INCOMPLETE && raw_load_complete_f ) {
        ...
        if( ! raw_end_of_stream_f ) {
            raw_load_complete_f = compilator_RawBuffer_load(&me->raw_buffer, 
                                                            me->base.byte_loader,
                                                            &raw_end_of_stream_f);
        } else  {
                                                ...
                                                const void**               end_p)
{
    ...
    compilator_RawBuffer_move_away_passed_content(&me->raw_buffer);
 ...
 * and stores it into the buffer.                                            */
{
    compilator_LexatomLoader_Converter* me  = (compilator_LexatomLoader_Converter*)alter_ego;
    compilator_RawBuffer*               raw = &me->raw_buffer;
    compilator_lexatom_t*                  insertion_p = RegionBeginP;
    ...
    load_result = compilator_LexatomLoader_call_converter(me, &insertion_p, 
                                                          RegionBeginP,
                                                          RegionEndP);
    (void)load_result;
                                        ...
                                        const compilator_lexatom_t*            RegionEndP)
{
    ...
    if( *insertion_p > RegionBeginP ) {
        compilator_LexatomLoader_remove_spurious_BOM(me, insertion_p, RegionBeginP);
                                             ...
                                             compilator_lexatom_t*                  RegionBeginP)
{
    ...
    __QUEX_STD_memmove(RegionBeginP, &RegionBeginP[1], 
                       (size_t)(*buffer_insertion_p - &RegionBeginP[1]) * sizeof(compilator_lexatom_t)); 
...
compilator_LexatomLoader_Converter_print_this(compilator_LexatomLoader* alter_ego)
{
    ...
    compilator_RawBuffer_print_this(&me->raw_buffer);
    compilator_Converter_print_this(me->converter);
}



#include "compilator\lib\buffer/lexatoms/LexatomLoader.i"
#include "compilator\lib\buffer/lexatoms/LexatomLoader_Converter_RawBuffer.i"
#include "compilator\lib\buffer/lexatoms/converter/Converter.i"

#endif /*  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_I */
