...
#ifndef QUEX_INCLUDE_GUARD_compilator__ANALYZER__ADAPTORS__FEEDER_I
#define QUEX_INCLUDE_GUARD_compilator__ANALYZER__ADAPTORS__FEEDER_I
...
inline
compilator_Feeder::compilator_Feeder(compilator* lexer,
                                     compilator_token_id_t  StreamTerminatingTokenId)
{ compilator_Feeder_construct(this, lexer, StreamTerminatingTokenId); }

inline void
compilator_Feeder::feed(const void* BeginP, const void* EndP)
{ compilator_Feeder_feed(this, BeginP, EndP); }

inline compilator_Token* 
compilator_Feeder::deliver()
{ return compilator_Feeder_deliver(this); }



inline void
compilator_Feeder_construct(compilator_Feeder*   me, 
                            compilator* lexer,
                            compilator_token_id_t  StreamTerminatingTokenId)
{
    /* Initialization                                                         */
...
inline void
compilator_Feeder_feed(compilator_Feeder* me, const void* BeginP, const void* EndP)
{
...
inline compilator_Token*
compilator_Feeder_deliver(compilator_Feeder* me)
{
    const bool        EndOfChunkF = me->external_chunk.begin_p == me->external_chunk.end_p ? true : false;
    compilator_Token*  token = compilator_receive_from_chunk(me->base.lexer, 
                                                            EndOfChunkF,
    ...
    while( ! token && me->external_chunk.begin_p != me->external_chunk.end_p ) {
        ...
        token = compilator_receive_from_chunk(me->base.lexer, EndOfChunkF,
                                              me->base.stream_terminating_token_id);
    }
    return token;
}
...
#endif /* QUEX_INCLUDE_GUARD_compilator__ANALYZER__ADAPTORS__FEEDER_I */
