...
#ifndef  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__CONVERTER__ICONV__CONVERTER_ICONV_I
#define  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__CONVERTER__ICONV__CONVERTER_ICONV_I
...
#include "quexProcessed/lib/buffer/lexatoms/converter/iconv/Converter_IConv"
...
inline bool 
quexProcessed_Converter_IConv_initialize(quexProcessed_Converter* me,
                                const char* FromCodec, const char* ToCodec);

inline bool    
quexProcessed_Converter_IConv_initialize_by_bom_id(struct quexProcessed_Converter_tag* me,
                                                E_ByteOrderMark                    BomId);

inline E_LoadResult 
quexProcessed_Converter_IConv_convert(quexProcessed_Converter*     me, 
                                   uint8_t**                 source, 
                                   const uint8_t*            SourceEnd,
                                   quexProcessed_lexatom_t**       drain,  
                                   const quexProcessed_lexatom_t*  DrainEnd);
inline void 
quexProcessed_Converter_IConv_delete_self(quexProcessed_Converter* me);

inline ptrdiff_t 
quexProcessed_Converter_IConv_stomach_byte_n(quexProcessed_Converter* me);

inline void 
quexProcessed_Converter_IConv_stomach_clear(quexProcessed_Converter* me);

inline void 
quexProcessed_Converter_IConv_print_this(quexProcessed_Converter* me);

inline quexProcessed_Converter*
quexProcessed_Converter_IConv_new(const char* FromCodec, const char* ToCodec)
{
    quexProcessed_Converter_IConv*  me = \
       (quexProcessed_Converter_IConv*)
       quex::MemoryManager_allocate(sizeof(quexProcessed_Converter_IConv),
    ...
    if( ! quexProcessed_Converter_construct(&me->base,
                                         FromCodec, ToCodec,
                                         quexProcessed_Converter_IConv_initialize,
                                         quexProcessed_Converter_IConv_initialize_by_bom_id,
                                         quexProcessed_Converter_IConv_convert,
                                         quexProcessed_Converter_IConv_delete_self,
                                         quexProcessed_Converter_IConv_stomach_byte_n,
                                         quexProcessed_Converter_IConv_stomach_clear,
                                         quexProcessed_Converter_IConv_print_this) ) {
...
inline bool 
quexProcessed_Converter_IConv_initialize(quexProcessed_Converter* alter_ego,
...
{
    quexProcessed_Converter_IConv* me              = (quexProcessed_Converter_IConv*)alter_ego;
...
inline bool    
quexProcessed_Converter_IConv_initialize_by_bom_id(quexProcessed_Converter* alter_ego,
                                                E_ByteOrderMark         BomId)
{
    quexProcessed_Converter_IConv* me = (quexProcessed_Converter_IConv*)alter_ego;
    const char* name;
...
inline E_LoadResult 
quexProcessed_Converter_IConv_convert(quexProcessed_Converter*     alter_ego, 
                                   uint8_t**                 source, 
                                   const uint8_t*            SourceEnd,
                                   quexProcessed_lexatom_t**       drain,  
                                   const quexProcessed_lexatom_t*  DrainEnd)
 ...
 *  <fschaef@users.sourceforge.net>.                                          */
{
    ...
    size_t                      drain_bytes_left_n  = (size_t)(DrainEnd - *drain)*sizeof(quexProcessed_lexatom_t);
    size_t                      report;
...
inline void 
quexProcessed_Converter_IConv_delete_self(quexProcessed_Converter* alter_ego)
{
    quexProcessed_Converter_IConv* me = (quexProcessed_Converter_IConv*)alter_ego;
...
inline void 
quexProcessed_Converter_IConv_print_this(quexProcessed_Converter* alter_ego)
{
    quexProcessed_Converter_IConv* me = (quexProcessed_Converter_IConv*)alter_ego;
...
#endif /*  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__CONVERTER__ICONV__CONVERTER_ICONV_I */
