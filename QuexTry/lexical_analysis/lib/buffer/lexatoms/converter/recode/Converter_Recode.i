...
#ifndef  QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__LEXATOMS__CONVERTER__RECODE__CONVERTER_RECODE_I
#define  QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__LEXATOMS__CONVERTER__RECODE__CONVERTER_RECODE_I
...
#include "lexical_analysis/lib/quex/MemoryManager"
     ...
     *                  source bytes are required.                           */
    {
        ...
        if( me->to_handle == 0x0 ) {
            /* Convert according to Calc_lexer_lexatom_t:
             *
             ...
             *       of Calc_lexer_lexatom_t. If you read these lines and know of a better
            ...
            __quex_assert( sizeof(Calc_lexer_lexatom_t) == 2 );
            ...
            ucnv_convertEx(me->to_handle, me->from_handle,
                           ...
                           me->pivot_buffer + QUEX_Calc_lexer_SETTING_ICU_PIVOT_BUFFER_SIZE,
                           /* reset = */FALSE, 
                           /* flush = */FALSE,
                           &me->status);
