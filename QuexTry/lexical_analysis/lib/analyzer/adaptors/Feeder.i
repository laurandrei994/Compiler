...
#ifndef QUEX_INCLUDE_GUARD_Calc_lexer__ANALYZER__ADAPTORS__FEEDER_I
#define QUEX_INCLUDE_GUARD_Calc_lexer__ANALYZER__ADAPTORS__FEEDER_I
...
#include "lexical_analysis/lib/analyzer/adaptors/Feeder"
 ...
 void
Calc_lexer_Feeder_construct(Calc_lexer_Feeder*   me, 
                            ...
                            Calc_lexer_token_id_t  StreamTerminatingTokenId)
{
    ...
    me->feed    = Calc_lexer_Feeder_feed;
    me->deliver = Calc_lexer_Feeder_deliver;
 ...
 void
Calc_lexer_Feeder_feed(Calc_lexer_Feeder* me, const void* BeginP, const void* EndP)
{
...
Calc_lexer_Feeder_deliver(Calc_lexer_Feeder* me)
{
    const bool        EndOfChunkF = me->external_chunk.begin_p == me->external_chunk.end_p ? true : false;
    struct Calc_lexer_Token_tag*  token = Calc_lexer_receive_from_chunk(me->base.lexer, 
                                                            EndOfChunkF,
    ...
    while( ! token && me->external_chunk.begin_p != me->external_chunk.end_p ) {
        ...
        token = Calc_lexer_receive_from_chunk(me->base.lexer, EndOfChunkF,
                                              me->base.stream_terminating_token_id);
    }
    return token;
}
...
#endif /* QUEX_INCLUDE_GUARD_Calc_lexer__ANALYZER__ADAPTORS__FEEDER_I */
