...
#ifndef  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__CONVERTER__ICONV__CONVERTER_ICONV_I
#define  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__CONVERTER__ICONV__CONVERTER_ICONV_I
...
#include "compilator\lib\buffer/lexatoms/converter/iconv/Converter_IConv"
...
inline bool 
compilator_Converter_IConv_initialize(compilator_Converter* me,
                                const char* FromCodec, const char* ToCodec);

inline bool    
compilator_Converter_IConv_initialize_by_bom_id(struct compilator_Converter_tag* me,
                                                E_ByteOrderMark                    BomId);

inline E_LoadResult 
compilator_Converter_IConv_convert(compilator_Converter*     me, 
                                   uint8_t**                 source, 
                                   const uint8_t*            SourceEnd,
                                   compilator_lexatom_t**       drain,  
                                   const compilator_lexatom_t*  DrainEnd);
inline void 
compilator_Converter_IConv_delete_self(compilator_Converter* me);

inline ptrdiff_t 
compilator_Converter_IConv_stomach_byte_n(compilator_Converter* me);

inline void 
compilator_Converter_IConv_stomach_clear(compilator_Converter* me);

inline void 
compilator_Converter_IConv_print_this(compilator_Converter* me);

inline compilator_Converter*
compilator_Converter_IConv_new(const char* FromCodec, const char* ToCodec)
{
    compilator_Converter_IConv*  me = \
       (compilator_Converter_IConv*)
       quex::MemoryManager_allocate(sizeof(compilator_Converter_IConv),
    ...
    if( ! compilator_Converter_construct(&me->base,
                                         FromCodec, ToCodec,
                                         compilator_Converter_IConv_initialize,
                                         compilator_Converter_IConv_initialize_by_bom_id,
                                         compilator_Converter_IConv_convert,
                                         compilator_Converter_IConv_delete_self,
                                         compilator_Converter_IConv_stomach_byte_n,
                                         compilator_Converter_IConv_stomach_clear,
                                         compilator_Converter_IConv_print_this) ) {
...
inline bool 
compilator_Converter_IConv_initialize(compilator_Converter* alter_ego,
...
{
    compilator_Converter_IConv* me              = (compilator_Converter_IConv*)alter_ego;
...
inline bool    
compilator_Converter_IConv_initialize_by_bom_id(compilator_Converter* alter_ego,
                                                E_ByteOrderMark         BomId)
{
    compilator_Converter_IConv* me = (compilator_Converter_IConv*)alter_ego;
    const char* name;
...
inline E_LoadResult 
compilator_Converter_IConv_convert(compilator_Converter*     alter_ego, 
                                   uint8_t**                 source, 
                                   const uint8_t*            SourceEnd,
                                   compilator_lexatom_t**       drain,  
                                   const compilator_lexatom_t*  DrainEnd)
 ...
 *  <fschaef@users.sourceforge.net>.                                          */
{
    ...
    size_t                      drain_bytes_left_n  = (size_t)(DrainEnd - *drain)*sizeof(compilator_lexatom_t);
    size_t                      report;
...
inline void 
compilator_Converter_IConv_delete_self(compilator_Converter* alter_ego)
{
    compilator_Converter_IConv* me = (compilator_Converter_IConv*)alter_ego;
...
inline void 
compilator_Converter_IConv_print_this(compilator_Converter* alter_ego)
{
    compilator_Converter_IConv* me = (compilator_Converter_IConv*)alter_ego;
...
#endif /*  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__CONVERTER__ICONV__CONVERTER_ICONV_I */
