 ...
 *
 * These functions ARE DEPENDENT on compilator_lexatom_t.
 * => Thus, they are placed in the analyzer's namespace.
 *
 * 2010 (C) Frank-Rene Schaefer; 
 * ABSOLUTELY NO WARRANTY                                                     */
#ifndef QUEX_INCLUDE_GUARD_compilator__unicode__LEXEME__CONVERTER_FROM_LEXEME_I
#define QUEX_INCLUDE_GUARD_compilator__unicode__LEXEME__CONVERTER_FROM_LEXEME_I
...
void
compilator_lexeme_to_utf32_character(const compilator_lexatom_t** input_pp, uint32_t** output_pp)
{
    uint32_t          unicode;
    int32_t           offset;
    compilator_lexatom_t input = *(*input_pp)++;
...
void
compilator_lexeme_to_utf16_character(const compilator_lexatom_t** input_pp, uint16_t** output_pp)
{
    uint32_t          unicode;
    int32_t           offset;
    compilator_lexatom_t input = *(*input_pp)++;
...
void
compilator_lexeme_to_utf8_character(const compilator_lexatom_t**  input_pp, uint8_t** output_pp)
{
    uint32_t          unicode;
    int32_t           offset;
    compilator_lexatom_t input = *(*input_pp)++;
 ...
 *                                                                            */
void
compilator_lexeme_to_char_character(const compilator_lexatom_t** source_pp, 
                                    char**                    drain_pp)  
{
    switch( sizeof(char) )
    {
    case 1:  compilator_lexeme_to_utf8_character(source_pp, (uint8_t**)drain_pp); break;
    case 2:  compilator_lexeme_to_utf16_character(source_pp, (uint16_t**)drain_pp); break;
    case 4:  compilator_lexeme_to_utf32_character(source_pp, (uint32_t**)drain_pp); break;
...
void
compilator_lexeme_to_wchar_t_character(const compilator_lexatom_t** source_pp, 
                                       wchar_t**                 drain_pp)  
{
...
void
compilator_lexeme_to_pretty_char_character(const compilator_lexatom_t** source_pp, 
                                           char**                    drain_pp)  
{
    char* write_p = *drain_pp;

    compilator_lexeme_to_char_character(source_pp, drain_pp);
 ...
 * larger segments.                                                           */
{
    const compilator_lexatom_t*  source_iterator; 
    uint8_t* drain_it;
    ...
    for(source_iterator=*source_pp; source_iterator != SourceEnd; ) { 
        ...
        compilator_lexeme_to_utf8_character(&source_iterator, &drain_it);
 ...
 *          Pointer to END of converted string.                               */
{
    ...
    drain_it = drain_p;
    for(source_iterator=SourceBegin; *source_iterator != (compilator_lexatom_t)0; ) {
        if( DrainEnd - drain_it < TargetMaxCodeUnitN ) {
            return (uint8_t*)0;
        }
        compilator_lexeme_to_utf8_character(&source_iterator, 
                                                          &drain_it);
...
compilator_lexeme_to_utf8(const std::basic_string<compilator_lexatom_t>& Source)
{
    ...
    uint8_t    tmp_drain[4];
    uint8_t*   drain_it;
    compilator_lexatom_t*          source = (compilator_lexatom_t*)
                                                quex::MemoryManager_allocate(
                                                sizeof(compilator_lexatom_t) * (Source.length() + 1),
                                                E_MemoryObjectType_TEXT);
    const size_t                SourceLength = Source.length();
    const compilator_lexatom_t*    source_it;
    ...
    for(source_it = &source[0]; source_it < &source[SourceLength]; ) {
        drain_it = tmp_drain;
        compilator_lexeme_to_utf8_character(&source_it, &drain_it);
 ...
 * larger segments.                                                           */
{
    ...
    for(source_iterator=*source_pp; source_iterator != SourceEnd; ) { 
        ...
        compilator_lexeme_to_utf16_character(&source_iterator, &drain_it);
        __quex_assert(source_iterator >  *source_pp);
        __quex_assert(source_iterator <= SourceEnd);
    }
 ...
 *          Pointer to END of converted string.                               */
{
    ...
    for(source_iterator=SourceBegin; *source_iterator != (compilator_lexatom_t)0; ) {
        ...
        compilator_lexeme_to_utf16_character(&source_iterator, 
                                                          &drain_it);
        __quex_assert(source_iterator > SourceBegin);
        __quex_assert(drain_it <= DrainEnd);
    } 
...
compilator_lexeme_to_utf16(const std::basic_string<compilator_lexatom_t>& Source)
{
    ...
    for(source_it = &source[0]; source_it < &source[SourceLength]; ) {
        drain_it = tmp_drain;
        compilator_lexeme_to_utf16_character(&source_it, &drain_it);
        __quex_assert(source_it >  &source[0]);
        __quex_assert(source_it <= &source[SourceLength]);
 ...
 * larger segments.                                                           */
{
    ...
    for(source_iterator=*source_pp; source_iterator != SourceEnd; ) { 
        ...
        compilator_lexeme_to_utf32_character(&source_iterator, &drain_it);
        __quex_assert(source_iterator >  *source_pp);
        __quex_assert(source_iterator <= SourceEnd);
    }
 ...
 *          Pointer to END of converted string.                               */
{
    ...
    for(source_iterator=SourceBegin; *source_iterator != (compilator_lexatom_t)0; ) {
        ...
        compilator_lexeme_to_utf32_character(&source_iterator, 
                                                          &drain_it);
        __quex_assert(source_iterator > SourceBegin);
        __quex_assert(drain_it <= DrainEnd);
    } 
...
compilator_lexeme_to_utf32(const std::basic_string<compilator_lexatom_t>& Source)
{
    ...
    for(source_it = &source[0]; source_it < &source[SourceLength]; ) {
        drain_it = tmp_drain;
        compilator_lexeme_to_utf32_character(&source_it, &drain_it);
        __quex_assert(source_it >  &source[0]);
        __quex_assert(source_it <= &source[SourceLength]);
 ...
 * larger segments.                                                           */
{
    ...
    for(source_iterator=*source_pp; source_iterator != SourceEnd; ) { 
        ...
        compilator_lexeme_to_char_character(&source_iterator, &drain_it);
        __quex_assert(source_iterator >  *source_pp);
        __quex_assert(source_iterator <= SourceEnd);
    }
 ...
 *          Pointer to END of converted string.                               */
{
    ...
    for(source_iterator=SourceBegin; *source_iterator != (compilator_lexatom_t)0; ) {
        ...
        compilator_lexeme_to_char_character(&source_iterator, 
                                                          &drain_it);
        __quex_assert(source_iterator > SourceBegin);
        __quex_assert(drain_it <= DrainEnd);
    } 
...
compilator_lexeme_to_char(const std::basic_string<compilator_lexatom_t>& Source)
{
    ...
    for(source_it = &source[0]; source_it < &source[SourceLength]; ) {
        drain_it = tmp_drain;
        compilator_lexeme_to_char_character(&source_it, &drain_it);
        __quex_assert(source_it >  &source[0]);
        __quex_assert(source_it <= &source[SourceLength]);
 ...
 * larger segments.                                                           */
{
    ...
    for(source_iterator=*source_pp; source_iterator != SourceEnd; ) { 
        ...
        compilator_lexeme_to_pretty_char_character(&source_iterator, &drain_it);
        __quex_assert(source_iterator >  *source_pp);
        __quex_assert(source_iterator <= SourceEnd);
    }
 ...
 *          Pointer to END of converted string.                               */
{
    ...
    for(source_iterator=SourceBegin; *source_iterator != (compilator_lexatom_t)0; ) {
        ...
        compilator_lexeme_to_pretty_char_character(&source_iterator, 
                                                          &drain_it);
        __quex_assert(source_iterator > SourceBegin);
        __quex_assert(drain_it <= DrainEnd);
    } 
...
compilator_lexeme_to_pretty_char(const std::basic_string<compilator_lexatom_t>& Source)
{
    ...
    for(source_it = &source[0]; source_it < &source[SourceLength]; ) {
        drain_it = tmp_drain;
        compilator_lexeme_to_pretty_char_character(&source_it, &drain_it);
        __quex_assert(source_it >  &source[0]);
        __quex_assert(source_it <= &source[SourceLength]);
        result.append((char*)tmp_drain, (size_t)(drain_it - tmp_drain));
    }
...
#if ! defined(QUEX_OPTION_WCHAR_T_DISABLED_EXT)
void
compilator_lexeme_nnzt_to_wchar_t(const compilator_lexatom_t**      source_pp, 
                                            const compilator_lexatom_t*        SourceEnd, 
                                            wchar_t**      drain_pp,  
 ...
 * larger segments.                                                           */
{
    ...
    for(source_iterator=*source_pp; source_iterator != SourceEnd; ) { 
        ...
        compilator_lexeme_to_wchar_t_character(&source_iterator, &drain_it);
        __quex_assert(source_iterator >  *source_pp);
        __quex_assert(source_iterator <= SourceEnd);
    }
...
wchar_t*
compilator_lexeme_to_wchar_t(const compilator_lexatom_t*         SourceBegin, 
                                        wchar_t*        drain_p,  
                                        const wchar_t*  DrainEnd)
/* Convert a zero-terminated lexeme. Adapt the drain pointer for quicker
 * iteration over write buffer. 
 ...
 *          Pointer to END of converted string.                               */
{
    ...
    for(source_iterator=SourceBegin; *source_iterator != (compilator_lexatom_t)0; ) {
        ...
        compilator_lexeme_to_wchar_t_character(&source_iterator, 
                                                          &drain_it);
        __quex_assert(source_iterator > SourceBegin);
        __quex_assert(drain_it <= DrainEnd);
    } 
...
compilator_lexeme_to_wchar_t(const std::basic_string<compilator_lexatom_t>& Source)
{
    /* Save iteration over string with existing character converters.
     * => copy string to a temporary array.                                   */
    wchar_t    tmp_drain[4];
    ...
    for(source_it = &source[0]; source_it < &source[SourceLength]; ) {
        drain_it = tmp_drain;
        compilator_lexeme_to_wchar_t_character(&source_it, &drain_it);
        __quex_assert(source_it >  &source[0]);
        __quex_assert(source_it <= &source[SourceLength]);
...
#endif /* QUEX_INCLUDE_GUARD_compilator__unicode__LEXEME__CONVERTER_FROM_LEXEME_I                 */
