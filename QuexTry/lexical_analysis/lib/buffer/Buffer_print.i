...
#ifndef QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__BUFFER_PRINT_I
#define QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__BUFFER_PRINT_I
...
#include "lexical_analysis/lib/lexeme/converter-from-lexeme"
 ...
 void  
Calc_lexer_Buffer_print_content_detailed_lines(Calc_lexer_lexatom_t** iterator, 
                                               Calc_lexer_lexatom_t*  Begin, 
                                               Calc_lexer_lexatom_t*  TotalEnd, 
                                               Calc_lexer_Buffer*  buffer);

 void  
Calc_lexer_Buffer_print_content(Calc_lexer_Buffer* me)
{
    Calc_lexer_Buffer_print_content_core(sizeof(Calc_lexer_lexatom_t),
 ...
 void  
Calc_lexer_Buffer_print_content_detailed(Calc_lexer_Buffer* me) 
{
    /* Assumptions: 
    ...
    Calc_lexer_lexatom_t*  iterator  = me->begin(me);
    Calc_lexer_lexatom_t*  total_end = me->end(me); 
    ...
    Calc_lexer_Buffer_print_content_detailed_lines(&iterator, me->begin(me),      total_end, me);
    Calc_lexer_Buffer_print_content_detailed_lines(&iterator, me->_lexeme_start_p - 2, total_end, me);
    Calc_lexer_Buffer_print_content_detailed_lines(&iterator, me->_read_p        - 2, total_end, me);
    if( me->content_end(me) != 0x0 ) {
        Calc_lexer_Buffer_print_content_detailed_lines(&iterator, me->content_end(me) - 4, total_end, me);
    }
    Calc_lexer_Buffer_print_content_detailed_lines(&iterator, me->content_space_end(me)   - 4, total_end, me);
    QUEX_DEBUG_PRINT("_________________________________________________________________\n");
}

 void  
Calc_lexer_Buffer_print_content_core(const size_t   ElementSize, 
                                     const uint8_t* Front,
                                     const uint8_t* Back,
                                     const uint8_t* ReadP,
                                     ...
                                     bool           BordersF)
{
 ...
 void  
Calc_lexer_Buffer_print_this(Calc_lexer_Buffer* me)
{
    ...
    QUEX_DEBUG_PRINT("{\n");
    Calc_lexer_BufferMemory_print_this(&me->_memory);

    QUEX_DEBUG_PRINT("    _read_p:                      ");
    quex_print_relative_positions(me->begin(me), me->end(me), 
                                             sizeof(Calc_lexer_lexatom_t), me->_read_p);
    QUEX_DEBUG_PRINT("\n");
    QUEX_DEBUG_PRINT("    _lexeme_start_p:              ");
    quex_print_relative_positions(me->begin(me), me->end(me), 
                                     sizeof(Calc_lexer_lexatom_t), me->_lexeme_start_p);
    QUEX_DEBUG_PRINT("\n");

    QUEX_DEBUG_PRINT1("    _lexatom_at_lexeme_start:     0x%X;\n", (int)me->_lexatom_at_lexeme_start);
    

    Calc_lexer_LexatomLoader_print_this(me->filler);

    QUEX_DEBUG_PRINT("    input: {\n");
    QUEX_DEBUG_PRINT1("      lexatom_index_begin: %i;\n", (int)Calc_lexer_Buffer_input_lexatom_index_begin(me));
    QUEX_DEBUG_PRINT1("      end_character_index: %i;\n", (int)Calc_lexer_Buffer_input_lexatom_index_end(me));
    QUEX_DEBUG_PRINT("      end_p:               ");
    quex_print_relative_positions(me->begin(me), me->end(me), 
                                     sizeof(Calc_lexer_lexatom_t), me->content_end(me));
    QUEX_DEBUG_PRINT("\n");
    QUEX_DEBUG_PRINT("    }\n");
    QUEX_DEBUG_PRINT("  }\n");
}
...
{
    int                 length = 0;
    Calc_lexer_lexatom_t*  end    = Begin + 5 > TotalEnd ? TotalEnd : Begin + 5;
 ...
 void
Calc_lexer_Buffer_print_overflow_message(Calc_lexer_Buffer* me)
{
    (void)me; 
    ...
    Calc_lexer_lexeme_nnzt_to_utf8(&iterator, End, &witerator, WEnd);
...
#endif /* QUEX_INCLUDE_GUARD_Calc_lexer__BUFFER__BUFFER_PRINT_I */
