...
#ifndef QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_FILL_I
#define QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_FILL_I
...
inline const void*
quexProcessed_Buffer_fill(quexProcessed_Buffer*  me, 
...
inline bool
quexProcessed_Buffer_fill_prepare(quexProcessed_Buffer*  me, 
                               void**              begin_p, 
                               const void**        end_p)
 ...
 * 'raw' buffer which still needs to be converted.                          */
{
    ...
    if( move_distance ) {
        (void)quexProcessed_Buffer_move_towards_begin(me, move_distance,
...
inline void
quexProcessed_Buffer_fill_finish(quexProcessed_Buffer* me,
 ...
 *                                                                           */
{
    __quex_assert((quexProcessed_lexatom_t*)FilledEndP <= me->content_space_end(me));
    ...
    if( me->filler->_byte_order_reversion_active_f ) {
        quexProcessed_LexatomLoader_reverse_byte_order(me->content_end(me), 
     ...
     *                                                                       */
    quexProcessed_Buffer_register_content(me, &me->content_end(me)[inserted_lexatom_n], -1);
...
#endif /* QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_FILL_I */
