...
#ifndef QUEX_INCLUDE_GUARD_Calc_lexer__ANALYZER__ADAPTORS__GAVAGER_I
#define QUEX_INCLUDE_GUARD_Calc_lexer__ANALYZER__ADAPTORS__GAVAGER_I

#include "lexical_analysis/lib/analyzer/adaptors/Gavager"
 ...
 void
Calc_lexer_Gavager_construct(Calc_lexer_Gavager*  me, 
                             struct Calc_lexer_tag*     lexer,
                             Calc_lexer_token_id_t      StreamTerminatingTokenId)
{
    /* Initialization                                                        */
    me->base.lexer                       = lexer;
    me->base.last_incomplete_lexeme_p    = (Calc_lexer_lexatom_t*)0;
    me->base.stream_terminating_token_id = StreamTerminatingTokenId;


    me->access  = Calc_lexer_Gavager_access;
    me->gavage  = Calc_lexer_Gavager_gavage;
    me->deliver = Calc_lexer_Gavager_deliver;


    if( ! QUEX_Calc_lexer_SETTING_FALLBACK_MANDATORY ) {
        ...
        Calc_lexer_MF_error_code_set_if_first(me->base.lexer, 
                                               E_Error_EngineNotGeneratedWithFallbackMandatory);
    }
}

 bool
Calc_lexer_Gavager_access(Calc_lexer_Gavager* me,
...
{
    Calc_lexer_Buffer* buffer = &me->base.lexer->buffer;
    return buffer->fill_prepare(&me->base.lexer->buffer, begin_p, end_p);
}

 bool
Calc_lexer_Gavager_gavage(Calc_lexer_Gavager* me, ptrdiff_t ReceivedN)
{
    void*              begin_p;
    const void*        end_p;
    Calc_lexer_Buffer* buffer = &me->base.lexer->buffer;
...
{
    return Calc_lexer_receive_from_chunk(me->base.lexer, true, 
...
#include "lexical_analysis/lib/analyzer/adaptors/Feeder.i"

#endif /*  QUEX_INCLUDE_GUARD_Calc_lexer__ANALYZER__ADAPTORS__GAVAGER_I */
