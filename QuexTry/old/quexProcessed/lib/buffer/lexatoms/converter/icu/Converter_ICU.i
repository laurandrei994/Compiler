...
#ifndef  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__CONVERTER__ICU__CONVERTER_ICU_I
#define  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__CONVERTER__ICU__CONVERTER_ICU_I

#include "quexProcessed/lib/definitions"
#include "quexProcessed/lib/buffer/lexatoms/converter/icu/Converter_ICU"
#include "quexProcessed/lib/quex/compatibility/stdint.h"
#include "quexProcessed/lib/quex/MemoryManager"

#include "quexProcessed/lib/analyzer/configuration/validation"



inline bool
quexProcessed_Converter_ICU_initialize(quexProcessed_Converter* me, 
                                    const char*           FromCoding, 
                                    const char*           ToCoding);
inline bool    
quexProcessed_Converter_ICU_initialize_by_bom_id(quexProcessed_Converter* me,
                                              E_ByteOrderMark         BomId);

inline E_LoadResult
quexProcessed_Converter_ICU_convert(quexProcessed_Converter*       me, 
                                 uint8_t**                   source, 
                                 const uint8_t*              SourceEnd, 
                                 quexProcessed_lexatom_t**       drain,  
                                 const quexProcessed_lexatom_t*  DrainEnd);
inline void
quexProcessed_Converter_ICU_delete_self(quexProcessed_Converter* me);

inline ptrdiff_t 
quexProcessed_Converter_ICU_stomach_byte_n(quexProcessed_Converter* me);

inline void 
quexProcessed_Converter_ICU_stomach_clear(quexProcessed_Converter* me);

inline void 
quexProcessed_Converter_ICU_print_this(quexProcessed_Converter* me);

inline quexProcessed_Converter*
quexProcessed_Converter_ICU_new(const char* FromCoding, const char* ToCoding)
{
    quexProcessed_Converter_ICU*  me = \
         (quexProcessed_Converter_ICU*)quex::MemoryManager_allocate(sizeof(quexProcessed_Converter_ICU),
    ...
    if( ! quexProcessed_Converter_construct(&me->base,
                                         FromCoding, ToCoding,
                                         quexProcessed_Converter_ICU_initialize,
                                         quexProcessed_Converter_ICU_initialize_by_bom_id,
                                         quexProcessed_Converter_ICU_convert,
                                         quexProcessed_Converter_ICU_delete_self,
                                         quexProcessed_Converter_ICU_stomach_byte_n,
                                         quexProcessed_Converter_ICU_stomach_clear,
                                         quexProcessed_Converter_ICU_print_this) ) {
        quex::MemoryManager_free((void*)me, E_MemoryObjectType_CONVERTER);
        return (quexProcessed_Converter*)0;
    }
...
inline bool
quexProcessed_Converter_ICU_initialize(quexProcessed_Converter* alter_ego, 
                                    const char*           FromCoding, 
                                    const char*           ToCoding)
...
{
    quexProcessed_Converter_ICU* me = (quexProcessed_Converter_ICU*)alter_ego;
...
inline bool    
quexProcessed_Converter_ICU_initialize_by_bom_id(quexProcessed_Converter* alter_ego,
                                              E_ByteOrderMark         BomId)
{
    quexProcessed_Converter_ICU* me = (quexProcessed_Converter_ICU*)alter_ego;
    const char* name;
    ...
    return quexProcessed_Converter_ICU_initialize(alter_ego, name, NULL);
}

inline E_LoadResult
quexProcessed_Converter_ICU_convert(quexProcessed_Converter*       alter_ego, 
                                 uint8_t**                   source, 
                                 const uint8_t*              SourceEnd, 
                                 quexProcessed_lexatom_t**       drain,  
                                 const quexProcessed_lexatom_t*  DrainEnd)
 ...
 *                  more source bytes are required.                      */
{
    ...
    __quex_assert(me->pivot.target     <= &me->pivot.buffer[QUEX_quexProcessed_SETTING_ICU_PIVOT_BUFFER_SIZE]);
    ...
    ucnv_convertEx(me->to_handle, me->from_handle,
                   ...
                   &me->pivot.buffer[0], &me->pivot.source, &me->pivot.target, &me->pivot.buffer[QUEX_quexProcessed_SETTING_ICU_PIVOT_BUFFER_SIZE],
...
inline ptrdiff_t 
quexProcessed_Converter_ICU_stomach_byte_n(quexProcessed_Converter* alter_ego)
...
inline void 
quexProcessed_Converter_ICU_stomach_clear(quexProcessed_Converter* alter_ego)
{
    quexProcessed_Converter_ICU* me = (quexProcessed_Converter_ICU*)alter_ego;
...
inline void
quexProcessed_Converter_ICU_delete_self(quexProcessed_Converter* alter_ego)
{
    quexProcessed_Converter_ICU* me = (quexProcessed_Converter_ICU*)alter_ego;
...
inline void 
quexProcessed_Converter_ICU_print_this(quexProcessed_Converter* alter_ego)
{
    quexProcessed_Converter_ICU* me = (quexProcessed_Converter_ICU*)alter_ego;
    const void*  PivotBegin = (const void*)&me->pivot.buffer[0];
    const void*  PivotEnd   = (const void*)&me->pivot.buffer[QUEX_quexProcessed_SETTING_ICU_PIVOT_BUFFER_SIZE];
    ...
    QUEX_DEBUG_PRINT3("           buffer: { begin: ((%p)) end: ((%p)) size: %i; }\n",
                      PivotBegin, PivotEnd, (int)QUEX_quexProcessed_SETTING_ICU_PIVOT_BUFFER_SIZE);
