...
#ifndef  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_I
#define  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_I
...
inline void
quexProcessed_LexatomLoader_Converter_construct(quexProcessed_LexatomLoader_Converter* me, 
                                             quexProcessed_ByteLoader*              byte_loader,
                                             quexProcessed_Converter*               converter,
                                             size_t                              RawMemorySize);

inline void   
quexProcessed_LexatomLoader_Converter_stomach_clear(quexProcessed_LexatomLoader* alter_ego);

inline void   
quexProcessed_LexatomLoader_Converter_destruct_self(quexProcessed_LexatomLoader* alter_ego);

inline ptrdiff_t   
quexProcessed_LexatomLoader_Converter_stomach_byte_n(quexProcessed_LexatomLoader* alter_ego);

inline size_t 
quexProcessed_LexatomLoader_Converter_load_lexatoms(quexProcessed_LexatomLoader*  alter_ego,
                                                 quexProcessed_lexatom_t*         RegionBeginP, 
                                                 const size_t               N,
                                                 bool*                      end_of_stream_f,
                                                 bool*                      encoding_error_f);
inline void 
quexProcessed_LexatomLoader_Converter_fill_prepare(quexProcessed_LexatomLoader*  alter_ego,
                                                quexProcessed_Buffer*         buffer,
                                                void**                     begin_p,
                                                const void**               end_p);

inline void 
quexProcessed_LexatomLoader_Converter_get_fill_boundaries(quexProcessed_LexatomLoader*  alter_ego,
                                                       quexProcessed_Buffer*         buffer,
                                                       void**       begin_p, 
                                                       const void** end_p);

inline ptrdiff_t 
quexProcessed_LexatomLoader_Converter_fill_finish(quexProcessed_LexatomLoader*   alter_ego,
                                              quexProcessed_lexatom_t*       insertion_p,
                                              const quexProcessed_lexatom_t* BufferEnd,
                                              const void*                ContentEnd);

inline E_LoadResult
quexProcessed_LexatomLoader_call_converter(quexProcessed_LexatomLoader_Converter* me,
                                        quexProcessed_lexatom_t**                 insertion_p,
                                        quexProcessed_lexatom_t*                  RegionBeginP,
                                        const quexProcessed_lexatom_t*            RegionEndP);
inline void
quexProcessed_LexatomLoader_remove_spurious_BOM(quexProcessed_LexatomLoader_Converter* me,
                                            quexProcessed_lexatom_t**                  buffer_insertion_p,
                                            quexProcessed_lexatom_t*                   RegionBeginP);

inline void 
quexProcessed_LexatomLoader_Converter_print_this(quexProcessed_LexatomLoader* alter_ego);

inline void   
quexProcessed_RawBuffer_init(quexProcessed_RawBuffer* me, 
                          uint8_t* Begin, size_t SizeInBytes);
inline void 
quexProcessed_RawBuffer_move_away_passed_content(quexProcessed_RawBuffer*  me);

inline bool 
quexProcessed_RawBuffer_load(quexProcessed_RawBuffer*   me,
                          quexProcessed_ByteLoader*  byte_loader, 
                          bool*                   end_of_stream_f);

inline quexProcessed_LexatomLoader*
quexProcessed_LexatomLoader_Converter_new(quexProcessed_ByteLoader* byte_loader,
                                       quexProcessed_Converter*  converter)
{ 
    quexProcessed_LexatomLoader_Converter*  me;
    /* UTF-8 char can be 6 bytes long => min. size of translation buffer.    */
    __quex_assert(QUEX_quexProcessed_SETTING_BUFFER_LEXATOM_LOADER_CONVERTER_BUFFER_SIZE >= 6);  
...
#   endif
    ...
    me = (quexProcessed_LexatomLoader_Converter*) \
          quex::MemoryManager_allocate(sizeof(quexProcessed_LexatomLoader_Converter),
                                         E_MemoryObjectType_BUFFER_FILLER);
    if( ! me) {
        return (quexProcessed_LexatomLoader*)0;
    }

    quexProcessed_LexatomLoader_Converter_construct(me, byte_loader, converter, 
                                                 QUEX_quexProcessed_SETTING_BUFFER_LEXATOM_LOADER_CONVERTER_BUFFER_SIZE);
                                             ...
                                             size_t                              RawMemorySize)
{
    ...
    quexProcessed_LexatomLoader_setup(&me->base,
                                  quexProcessed_LexatomLoader_Converter_load_lexatoms,
                                  quexProcessed_LexatomLoader_Converter_stomach_byte_n,
                                  quexProcessed_LexatomLoader_Converter_stomach_clear,
                                  quexProcessed_LexatomLoader_Converter_destruct_self,
                                  quexProcessed_LexatomLoader_Converter_fill_prepare,
                                  quexProcessed_LexatomLoader_Converter_fill_finish,
                                  quexProcessed_LexatomLoader_Converter_get_fill_boundaries,
                                  quexProcessed_LexatomLoader_Converter_print_this,
                                  byte_loader,
                                  byte_n_per_lexatom);
    ...
    quexProcessed_RawBuffer_init(&me->raw_buffer, raw_memory, RawMemorySize);
 ...
 *                 in the stomach.                                           */
{
    quexProcessed_LexatomLoader_Converter* me = (quexProcessed_LexatomLoader_Converter*)alter_ego;
    ptrdiff_t  byte_n;
...
{
    quexProcessed_LexatomLoader_Converter* me = (quexProcessed_LexatomLoader_Converter*)alter_ego;
    quexProcessed_RawBuffer_init(&me->raw_buffer, 0, 0);
    quexProcessed_Converter_reset(me->converter);
}
...
{
    quexProcessed_LexatomLoader_Converter* me = (quexProcessed_LexatomLoader_Converter*)alter_ego;
    quexProcessed_RawBuffer*               raw = &me->raw_buffer;
    quexProcessed_lexatom_t*                  buffer_insertion_p = RegionBeginP;
    const quexProcessed_lexatom_t*            BufferRegionEnd    = &RegionBeginP[N];
    E_LoadResult                        load_result;
    bool                                raw_load_complete_f;
    bool                                raw_end_of_stream_f;
#   if 0
    int                              i;
    quexProcessed_lexatom_t*               buffer_insertion_begin_p;
#   endif
    ...
    load_result = quexProcessed_LexatomLoader_call_converter(me, &buffer_insertion_p, 
                                                          RegionBeginP,
                                                          BufferRegionEnd);
    ...
    while( load_result == E_LoadResult_INCOMPLETE && raw_load_complete_f ) {
        ...
        if( ! raw_end_of_stream_f ) {
            raw_load_complete_f = quexProcessed_RawBuffer_load(&me->raw_buffer, 
                                                            me->base.byte_loader,
                                                            &raw_end_of_stream_f);
        } else  {
                                                ...
                                                const void**               end_p)
{
    ...
    quexProcessed_RawBuffer_move_away_passed_content(&me->raw_buffer);
 ...
 * and stores it into the buffer.                                            */
{
    quexProcessed_LexatomLoader_Converter* me  = (quexProcessed_LexatomLoader_Converter*)alter_ego;
    quexProcessed_RawBuffer*               raw = &me->raw_buffer;
    quexProcessed_lexatom_t*                  insertion_p = RegionBeginP;
    ...
    load_result = quexProcessed_LexatomLoader_call_converter(me, &insertion_p, 
                                                          RegionBeginP,
                                                          RegionEndP);
    (void)load_result;
                                        ...
                                        const quexProcessed_lexatom_t*            RegionEndP)
{
    ...
    if( *insertion_p > RegionBeginP ) {
        quexProcessed_LexatomLoader_remove_spurious_BOM(me, insertion_p, RegionBeginP);
                                             ...
                                             quexProcessed_lexatom_t*                  RegionBeginP)
{
    ...
    __QUEX_STD_memmove(RegionBeginP, &RegionBeginP[1], 
                       (size_t)(*buffer_insertion_p - &RegionBeginP[1]) * sizeof(quexProcessed_lexatom_t)); 
...
quexProcessed_LexatomLoader_Converter_print_this(quexProcessed_LexatomLoader* alter_ego)
{
    ...
    quexProcessed_RawBuffer_print_this(&me->raw_buffer);
    quexProcessed_Converter_print_this(me->converter);
}



#include "quexProcessed/lib/buffer/lexatoms/LexatomLoader.i"
#include "quexProcessed/lib/buffer/lexatoms/LexatomLoader_Converter_RawBuffer.i"
#include "quexProcessed/lib/buffer/lexatoms/converter/Converter.i"

#endif /*  QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__LEXATOMS__LEXATOM_LOADER_CONVERTER_I */
