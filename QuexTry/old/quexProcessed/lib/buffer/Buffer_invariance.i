/* vim:set ft=c: -*- C++ -*- */
#ifndef QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_INVARIANCE_I
#define QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_INVARIANCE_I



inline void
quexProcessed_BufferInvariance_construct(quexProcessed_BufferInvariance* me, 
                                      quexProcessed_Buffer*           subject)
/* Store all buffer related pointers and indicates present in 'subject'.      */
{
    quexProcessed_Buffer_assert_pointers_in_range(subject);
...
inline void
quexProcessed_BufferInvariance_assert(quexProcessed_BufferInvariance* me, 
                                   quexProcessed_Buffer*           subject,
                                   bool                         SameF)
...
inline void
quexProcessed_BufferInvariance_restore(quexProcessed_BufferInvariance* me, 
                                    quexProcessed_Buffer*           subject)
...
#endif /* QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_INVARIANCE_I */
