...
#ifndef QUEX_INCLUDE_GUARD_compilator__BUFFER__BUFFER_FILL_I
#define QUEX_INCLUDE_GUARD_compilator__BUFFER__BUFFER_FILL_I
...
inline const void*
compilator_Buffer_fill(compilator_Buffer*  me, 
...
inline bool
compilator_Buffer_fill_prepare(compilator_Buffer*  me, 
                               void**              begin_p, 
                               const void**        end_p)
 ...
 * 'raw' buffer which still needs to be converted.                          */
{
    ...
    if( move_distance ) {
        (void)compilator_Buffer_move_towards_begin(me, move_distance,
...
inline void
compilator_Buffer_fill_finish(compilator_Buffer* me,
 ...
 *                                                                           */
{
    __quex_assert((compilator_lexatom_t*)FilledEndP <= me->content_space_end(me));
    ...
    if( me->filler->_byte_order_reversion_active_f ) {
        compilator_LexatomLoader_reverse_byte_order(me->content_end(me), 
     ...
     *                                                                       */
    compilator_Buffer_register_content(me, &me->content_end(me)[inserted_lexatom_n], -1);
...
#endif /* QUEX_INCLUDE_GUARD_compilator__BUFFER__BUFFER_FILL_I */
