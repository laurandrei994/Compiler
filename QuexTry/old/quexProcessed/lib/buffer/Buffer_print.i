...
#ifndef QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_PRINT_I
#define QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_PRINT_I
...
inline void  
quexProcessed_Buffer_print_content_detailed_lines(quexProcessed_lexatom_t** iterator, 
                                               quexProcessed_lexatom_t*  Begin, 
                                               quexProcessed_lexatom_t*  TotalEnd, 
                                               quexProcessed_Buffer*  buffer);

inline void  
quexProcessed_Buffer_print_content(quexProcessed_Buffer* me)
{
    quexProcessed_Buffer_print_content_core(sizeof(quexProcessed_lexatom_t),
...
inline void  
quexProcessed_Buffer_print_content_detailed(quexProcessed_Buffer* me) 
{
    /* Assumptions: 
    ...
    quexProcessed_lexatom_t*  iterator  = me->begin(me);
    quexProcessed_lexatom_t*  total_end = me->end(me); 
    ...
    quexProcessed_Buffer_print_content_detailed_lines(&iterator, me->begin(me),      total_end, me);
    quexProcessed_Buffer_print_content_detailed_lines(&iterator, me->_lexeme_start_p - 2, total_end, me);
    quexProcessed_Buffer_print_content_detailed_lines(&iterator, me->_read_p        - 2, total_end, me);
    if( me->content_end(me) != 0x0 ) {
        quexProcessed_Buffer_print_content_detailed_lines(&iterator, me->content_end(me) - 4, total_end, me);
    }
    quexProcessed_Buffer_print_content_detailed_lines(&iterator, me->content_space_end(me)   - 4, total_end, me);
    QUEX_DEBUG_PRINT("_________________________________________________________________\n");
}

inline void  
quexProcessed_Buffer_print_content_core(const size_t   ElementSize, 
                                     const uint8_t* Front,
                                     const uint8_t* Back,
                                     const uint8_t* ReadP,
...
inline void  
quexProcessed_Buffer_print_this(quexProcessed_Buffer* me)
{
    ...
    QUEX_DEBUG_PRINT("{\n");
    quexProcessed_BufferMemory_print_this(&me->_memory);

    QUEX_DEBUG_PRINT("    _read_p:                      ");
    quex::print_relative_positions(me->begin(me), me->end(me), 
                                             sizeof(quexProcessed_lexatom_t), me->_read_p);
    QUEX_DEBUG_PRINT("\n");
    QUEX_DEBUG_PRINT("    _lexeme_start_p:              ");
    quex::print_relative_positions(me->begin(me), me->end(me), 
                                     sizeof(quexProcessed_lexatom_t), me->_lexeme_start_p);
    QUEX_DEBUG_PRINT("\n");

    QUEX_DEBUG_PRINT1("    _lexatom_at_lexeme_start:     0x%X;\n", (int)me->_lexatom_at_lexeme_start);
    

    quexProcessed_LexatomLoader_print_this(me->filler);

    QUEX_DEBUG_PRINT("    input: {\n");
    QUEX_DEBUG_PRINT1("      lexatom_index_begin: %i;\n", (int)quexProcessed_Buffer_input_lexatom_index_begin(me));
    QUEX_DEBUG_PRINT1("      end_character_index: %i;\n", (int)quexProcessed_Buffer_input_lexatom_index_end(me));
    QUEX_DEBUG_PRINT("      end_p:               ");
    quex::print_relative_positions(me->begin(me), me->end(me), 
                                     sizeof(quexProcessed_lexatom_t), me->content_end(me));
    QUEX_DEBUG_PRINT("\n");
    QUEX_DEBUG_PRINT("    }\n");
    QUEX_DEBUG_PRINT("  }\n");
}
...
{
    int                 length = 0;
    quexProcessed_lexatom_t*  end    = Begin + 5 > TotalEnd ? TotalEnd : Begin + 5;
...
inline void
quexProcessed_Buffer_print_overflow_message(quexProcessed_Buffer* me)
{
    (void)me; 
    ...
    quexProcessed_lexatom_t*        End        = 0x0;
    ...
    quexProcessed_lexeme_nnzt_to_utf8(&iterator, End, &witerator, WEnd);
...
#endif /* QUEX_INCLUDE_GUARD_quexProcessed__BUFFER__BUFFER_PRINT_I */
