...
#ifndef  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__CONVERTER__ICU__CONVERTER_ICU_I
#define  QUEX_INCLUDE_GUARD_compilator__BUFFER__LEXATOMS__CONVERTER__ICU__CONVERTER_ICU_I

#include "compilator\lib\definitions"
#include "compilator\lib\buffer/lexatoms/converter/icu/Converter_ICU"
#include "compilator\lib\quex/compatibility/stdint.h"
#include "compilator\lib\quex/MemoryManager"

#include "compilator\lib\analyzer/configuration/validation"



inline bool
compilator_Converter_ICU_initialize(compilator_Converter* me, 
                                    const char*           FromCoding, 
                                    const char*           ToCoding);
inline bool    
compilator_Converter_ICU_initialize_by_bom_id(compilator_Converter* me,
                                              E_ByteOrderMark         BomId);

inline E_LoadResult
compilator_Converter_ICU_convert(compilator_Converter*       me, 
                                 uint8_t**                   source, 
                                 const uint8_t*              SourceEnd, 
                                 compilator_lexatom_t**       drain,  
                                 const compilator_lexatom_t*  DrainEnd);
inline void
compilator_Converter_ICU_delete_self(compilator_Converter* me);

inline ptrdiff_t 
compilator_Converter_ICU_stomach_byte_n(compilator_Converter* me);

inline void 
compilator_Converter_ICU_stomach_clear(compilator_Converter* me);

inline void 
compilator_Converter_ICU_print_this(compilator_Converter* me);

inline compilator_Converter*
compilator_Converter_ICU_new(const char* FromCoding, const char* ToCoding)
{
    compilator_Converter_ICU*  me = \
         (compilator_Converter_ICU*)quex::MemoryManager_allocate(sizeof(compilator_Converter_ICU),
    ...
    if( ! compilator_Converter_construct(&me->base,
                                         FromCoding, ToCoding,
                                         compilator_Converter_ICU_initialize,
                                         compilator_Converter_ICU_initialize_by_bom_id,
                                         compilator_Converter_ICU_convert,
                                         compilator_Converter_ICU_delete_self,
                                         compilator_Converter_ICU_stomach_byte_n,
                                         compilator_Converter_ICU_stomach_clear,
                                         compilator_Converter_ICU_print_this) ) {
        quex::MemoryManager_free((void*)me, E_MemoryObjectType_CONVERTER);
        return (compilator_Converter*)0;
    }
...
inline bool
compilator_Converter_ICU_initialize(compilator_Converter* alter_ego, 
                                    const char*           FromCoding, 
                                    const char*           ToCoding)
...
{
    compilator_Converter_ICU* me = (compilator_Converter_ICU*)alter_ego;
...
inline bool    
compilator_Converter_ICU_initialize_by_bom_id(compilator_Converter* alter_ego,
                                              E_ByteOrderMark         BomId)
{
    compilator_Converter_ICU* me = (compilator_Converter_ICU*)alter_ego;
    const char* name;
    ...
    return compilator_Converter_ICU_initialize(alter_ego, name, NULL);
}

inline E_LoadResult
compilator_Converter_ICU_convert(compilator_Converter*       alter_ego, 
                                 uint8_t**                   source, 
                                 const uint8_t*              SourceEnd, 
                                 compilator_lexatom_t**       drain,  
                                 const compilator_lexatom_t*  DrainEnd)
 ...
 *                  more source bytes are required.                      */
{
    ...
    __quex_assert(me->pivot.target     <= &me->pivot.buffer[QUEX_compilator_SETTING_ICU_PIVOT_BUFFER_SIZE]);
    ...
    ucnv_convertEx(me->to_handle, me->from_handle,
                   ...
                   &me->pivot.buffer[0], &me->pivot.source, &me->pivot.target, &me->pivot.buffer[QUEX_compilator_SETTING_ICU_PIVOT_BUFFER_SIZE],
...
inline ptrdiff_t 
compilator_Converter_ICU_stomach_byte_n(compilator_Converter* alter_ego)
...
inline void 
compilator_Converter_ICU_stomach_clear(compilator_Converter* alter_ego)
{
    compilator_Converter_ICU* me = (compilator_Converter_ICU*)alter_ego;
...
inline void
compilator_Converter_ICU_delete_self(compilator_Converter* alter_ego)
{
    compilator_Converter_ICU* me = (compilator_Converter_ICU*)alter_ego;
...
inline void 
compilator_Converter_ICU_print_this(compilator_Converter* alter_ego)
{
    compilator_Converter_ICU* me = (compilator_Converter_ICU*)alter_ego;
    const void*  PivotBegin = (const void*)&me->pivot.buffer[0];
    const void*  PivotEnd   = (const void*)&me->pivot.buffer[QUEX_compilator_SETTING_ICU_PIVOT_BUFFER_SIZE];
    ...
    QUEX_DEBUG_PRINT3("           buffer: { begin: ((%p)) end: ((%p)) size: %i; }\n",
                      PivotBegin, PivotEnd, (int)QUEX_compilator_SETTING_ICU_PIVOT_BUFFER_SIZE);
